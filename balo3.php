...
<body>
    ...
    <main>
        <div class="product-image">
            <img src="img/3.jpg" alt="Balo 3">
        </div>

        <div class="product-info">
            <h3>Balo họa tiết xanh lục</h3>
        ...
        <p><span>Kích thước:</span> <span>39cm x 29cm x 12cm</span></p>
        <p><span>Chất liệu:</span> <span>Vải</span></p>
        <p><span>Xuất xứ:</span> <span>Việt Nam</span></p>
        <p><span>Bảo hành:</span> <span>03 tháng</span></p>
    </div>
        </div>
    </main>
