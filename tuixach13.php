...
<body>
    ...
    <main>
        <div class="product-image">
            <img src="img/13.jpg" alt="Túi xách, đeo chéo dễ thương">
        </div>

        <div class="product-info">
            <h3>Túi xách, đeo chéo dễ thương</h3>
